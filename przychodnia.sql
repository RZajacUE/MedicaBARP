...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2023 at 08:42 PM
...
INSERT INTO `lekarze` (`IdLekarza`, `Imie`, `Nazwisko`, `Specjalizacja`, `NrLicencjiLekarskiej`, `NumerPokoju`) VALUES
(1, 'Adam', 'Nowak', 'Kardiolog', 'L12345', NULL),
(2, 'Ewa', 'Kowalska', 'Dermatolog', 'L54321', NULL),
(3, 'Marek', 'Wójcik', 'Ortopeda', 'L98765', NULL),
(4, 'Anna', 'Lis', 'Neurolog', 'L45678', NULL),
(5, 'Jan', 'Kaczor', 'Ginekolog', 'L87654', NULL),
(6, 'Karolina', 'Jankowska', 'Pediatra', 'L23456', NULL),
(7, 'Piotr', 'Wiśniewski', 'Chirurg', 'L65432', NULL),
(8, 'Alicja', 'Duda', 'Internista', 'L76543', NULL);
...
--
ALTER TABLE `pacjenci`
  MODIFY `IdPacjenta` int(11) NOT NULL AUTO_INCREMENT;
